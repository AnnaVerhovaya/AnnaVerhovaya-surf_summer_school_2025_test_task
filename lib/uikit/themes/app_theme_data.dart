...
import 'package:surf_summer_school_2025_test_task/uikit/themes/text/app_text_theme.dart';
...
abstract class AppThemeData {
  ...
  static final darkTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle:
          _textTheme.subtitle.copyWith(color: _darkColorTheme.textPrimary),
    ),
  ...
  static final lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle:
          _textTheme.subtitle.copyWith(color: _lightColorTheme.textPrimary),
    ),
    dividerTheme: DividerThemeData(
