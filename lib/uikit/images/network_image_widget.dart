...
import 'package:surf_summer_school_2025_test_task/core/constants/icons_constants.dart';
import 'package:surf_summer_school_2025_test_task/uikit/images/svg_picture_widget.dart';
import 'package:surf_summer_school_2025_test_task/uikit/themes/colors/app_color_theme.dart';
...
class NetworkImageWidget extends StatelessWidget {
  ...
  const NetworkImageWidget(
      {required this.imgUrl, required this.height, super.key});
...
class _ImagePlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: height,
      child: Center(
        child: SvgPictureWidget(AppSvgIcons.icPhoto,
            color: AppColorTheme.of(context).inactive, width: 64, height: 64),
      ),
    );
  }
}
